...
shopModule:addBuyableItemContainer({'bp s'}, 2000, 8704, 420, 'backpack of small health potions')
shopModule:addBuyableItem({'health potion'}, 7618, 45, 'health potion')
shopModule:addBuyableItemContainer({'bp h'}, 2000, 7618, 920, 'backpack of health potions')
shopModule:addBuyableItem({'mana potion'}, 7620, 50, 'mana potion')
shopModule:addBuyableItemContainer({'bp m'}, 2000, 7620, 1020, 'backpack of mana potions')
shopModule:addBuyableItem({'strong health'}, 7588, 100, 'strong health potion')
shopModule:addBuyableItemContainer({'bp sh'}, 2000, 7588, 2020, 'backpack of stront health potions')
shopModule:addBuyableItem({'strong mana'}, 7589, 80, 'strong mana potion')
shopModule:addBuyableItemContainer({'bp sm'}, 2000, 7589, 1620, 'backpack of stront mana potions')
shopModule:addBuyableItem({'great health'}, 7591, 190, 'great health potion')
shopModule:addBuyableItemContainer({'bp gh'}, 2000, 7591, 3820, 'backpack of great health potions')
shopModule:addBuyableItem({'great mana'}, 7590, 120, 'great mana potion')
shopModule:addBuyableItemContainer({'bp gm'}, 2000, 7590, 2420, 'backpack of great mana potions')
shopModule:addBuyableItem({'great spirit'}, 8472, 190, 'great spirit potion')
shopModule:addBuyableItemContainer({'bp gs'}, 2000, 8472, 3820, 'backpack of great spirit potions')
shopModule:addBuyableItem({'ultimate health'}, 8473, 210, 'ultimate health potion')
shopModule:addBuyableItemContainer({'bp uh'}, 2000, 8473, 4220, 'backpack of ultimate health potions')
