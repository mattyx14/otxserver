...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "addon") or msgcontains(msg, "outfit") or msgcontains(msg, "hat") then
		...
		if addonProgress < 1 then
			npcHandler:say("Pretty, isn't it? My friend Citizen taught me how to make it, but I could help you with one if you like. What do you say?", cid)
...
npcHandler:setMessage(MESSAGE_GREET, 'Oh |PLAYERNAME|. What do you need?')
