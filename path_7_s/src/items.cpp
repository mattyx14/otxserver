...
bool Items::loadFromXml()
{
	...
	pugi::xml_parse_result result = doc.load_file("data/items/" ITEMS_PATH "/items.xml");
	if (!result) {
		printXMLError("Error - Items::loadFromXml", "data/items/" ITEMS_PATH "/items.xml", result);
		return false;
	}
