...
std::string ProtocolStatus::SERVER_VERSION = "7";
std::string ProtocolStatus::SERVER_DEVELOPERS = "Based on: Canary (3 - Series). And data edited by: Mattyx14 from OpenTibiaBR Organization.";
