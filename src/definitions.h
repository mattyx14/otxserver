...
static constexpr auto STATUS_SERVER_DEVELOPERS = "Matt Gomez, Leandro Brewster, Erick Nunes, João Leonardo Pereira, Javier Carreon, OTX Contributors and The Forgotten Server Developers";
...
static constexpr auto CLIENT_VERSION_STR = "10.99 - 10.00";
