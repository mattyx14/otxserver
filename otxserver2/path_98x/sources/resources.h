...
#include "definitions.h"
	...
	#define ID_MENU_RELOAD_MOUNTS 509
	#define ID_MENU_RELOAD_MOVEMENTS 510
	#define ID_MENU_RELOAD_OUTFITS 511
	#define ID_MENU_RELOAD_QUESTS 512
	#define ID_MENU_RELOAD_RAIDS 513
	#define ID_MENU_RELOAD_SPELLS 514
	#define ID_MENU_RELOAD_STAGES 515
	#define ID_MENU_RELOAD_TALKACTIONS 516
	#define ID_MENU_RELOAD_MODS 527
...
// Compatible with 9.80 - 9.86
#define CLIENT_VERSION_MIN 972
#define CLIENT_VERSION_MAX 978
#define CLIENT_VERSION_ITEMS 49
#define CLIENT_VERSION_STRING "9.86"
