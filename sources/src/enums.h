...
enum ReturnValue {
	...
	RETURNVALUE_NOTENOUGHFISTLEVEL = 64,
	RETURNVALUE_NOTENOUGHCLUBLEVEL = 65,
	RETURNVALUE_NOTENOUGHSWORDLEVEL = 66,
	RETURNVALUE_NOTENOUGHAXELEVEL = 67,
	RETURNVALUE_NOTENOUGHDISTANCELEVEL = 68,
	RETURNVALUE_NOTENOUGHSHIELDLEVEL = 69,
	RETURNVALUE_NOTENOUGHFISHLEVEL = 70
};
